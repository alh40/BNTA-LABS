...
public class ControlFlowExercises {
    ...
    /*
        ...
        Unless it is winter, then the lower limit is 10 instead of 15.

        Given an int temp and a boolean isWinter,
    ...
    boolean kidsRide(int temp, boolean isWinter) {
        ...
        if(temp >= 15 && temp <= 30 && isWinter == false){

            return true;
        }else if(isWinter == true && temp >= 10 && temp <=30 ){
            return true;
        }else{
            return false;
        }
    ...
    if(a == 8 || b == 8 || 8 == Math.abs(a + b) ||  Math.abs(a - b) == 8 || a * b == 8){
        return true;
    }
        return false;
    }
    ...
    boolean goOut(boolean isSunday, boolean isMom, boolean isPast20) {
        ...
        if(isSunday == true && isMom == true && isPast20 == false){
            return true;
        }else if(isSunday == false && isPast20 == false){
            return true;
        }else{
            return false;
        }
    ...
    boolean hangPaintings(int small, int big, int length) {
        ...
        if(small + newBig == length || length / 5 == big || small % length == 0){
            return true;
        }
